...
inputs = {
  vm_name           = ["${include.environment.inputs.environment_name}-app1", "${include.environment.inputs.environment_name}-app2", "${include.environment.inputs.environment_name}-app3"]
  vm_image          = "image-test"
  vm_machine_type   = ["e2-medium", "e2-medium", "e2-medium"]
  vm_tags           = ["webserver"]
