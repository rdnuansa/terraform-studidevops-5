...
inputs = {
  vm_name           = ["${include.environment.inputs.environment_name}-app1", "${include.environment.inputs.environment_name}-app2"]
  vm_image          = "projects/sandbox-376723/global/images/image-test"
  vm_machine_type   = ["e2-medium", "e2-medium"]
  vm_tags           = ["webserver"]
